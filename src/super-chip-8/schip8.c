...
void tick(SCHIP8* schip8, Display* display, Device* device) {
	...
	decode_and_execute(schip8, display, instruction, device);
}
		...
		switch((instruction & 0xF000) >> 12) {
			case 0x00:
				switch (instruction & 0x00FF) {
					...
					case 0xCA: case 0xC9: case 0xCA: case 0xCB: case 0xCC: case 0xCD: case 0xCE: case 0xCF:
						op_00CN(schip8, display);
						break;
					case 0xFB:
					...
					case 0xFC:
						...
						break;
					case 0xFD:
						op_00FD(schip8, device);
						break;
				}
				break;
			case 0x0D:
				op_DXY0(schip8, display);
				break;
			case 0x0F:
